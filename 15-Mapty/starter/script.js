...
class App {
    ...
    _newWorkout(e) {
        ...
        if (type === "running") {
            ...
            const isValid = validInputs(distance, duration, cadence)
            console.log(isValid)
            // check if data is valid
            if (!isValid || !allPositive(distance, duration, cadence)) return alert('Inputs have to be positive numbers.')
        ...
        if (type === "cycling") {
            ...
            if (//!Number.isFinite(distance) || !Number.isFinite(duration) || !Number.isFinite(elevation)
                ...
                !allPositive(distance, duration)) return alert('Inputs have to be positive.')
        ...
        //hide form and clear inpiut fields
        this._hideForm();
