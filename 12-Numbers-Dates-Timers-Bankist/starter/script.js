...
const account1 = {
  ...
  movementsDates: [
    ...
    '2022-06-28T14:11:59.604Z',
    '2022-07-01T17:01:17.194Z',
    '2022-07-06T20:36:17.929Z',
    '2022-07-08T00:51:36.790Z',
  ],
  currency: 'EUR',
  locale: 'pt-PT', // de-DE
};
...
const calcDisplaySummary = function (acc) {
  ...
  const formattedMovIncomes = formatCur(incomes, acc.locale, acc.currency)
  labelSumIn.textContent = `${formattedMovIncomes}`;
...
//   Array.from(document.querySelectorAll('.movements__row')).forEach(function (row, i) {
...
// console.log(5463643754976075845437454754679765868n);

// Operations
// console.log(10000n + 10000n)

// cannot mix bigint and reg number
// const huge = 54345469656796559655n
// const num = 23;
...
// console.log(new Date('August 24, 2022'));
...
//   const now = new Date();
//   console.log(`${String(now.getHours()).padStart(2, 0)} : ${now.getMinutes()} : ${now.getSeconds()}`)
// }, 1000)
